...
fig.update_layout(
    ...
    height=750,  # Set the height of the map
...
fig_trending = px.bar(top_trending,
                      x='Traffic volume',
                      y='Title',
                      orientation='h',
...
fig_trending.update_layout(
    ...
    height=600,
    margin={"r":0,"t":50,"l":0,"b":0},
    yaxis=dict(categoryorder='total ascending')  # Order the bars from top to bottom
)
